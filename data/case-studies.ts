...
export const caseStudies: CaseStudy[] = [
  {
    ...
    role: "Discovery, architecture and full-stack engineering",
    year: "2026",
    ...
    chapters: [
      ...
      },
      {
        ...
        body: [
          "Before proposing anything, we spent a month with them — on site, in the office, and on the factory floor. Not a kickoff workshop; a month of watching the work happen.",
          ...
          "We walked out with a supplier price list per profile system, glass and hardware invoices, a completed frame job file, a completed frameless job pack, real recent quotations, and the staff list with roles. Those documents became the system's defaults instead of our assumptions.",
