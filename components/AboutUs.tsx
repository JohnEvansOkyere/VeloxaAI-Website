...
export default function AboutUs() {
  ...
  return (
    <section id="about" className="section-padding bg-neutral-offwhite dark:bg-neutral-dark">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="grid md:grid-cols-2 lg:grid-cols-4 gap-8">
          {team.map((member, index) => (
            <div
              key={index}
              className="bg-white dark:bg-neutral-dark/50 rounded-2xl p-6 border border-neutral-dark/10 dark:border-white/10 hover:shadow-xl hover:scale-105 transition-all duration-300"
            >
              {/* Profile Image */}
              <div className="relative w-32 h-32 mx-auto mb-6 rounded-full overflow-hidden bg-gradient-to-br from-primary-turquoise to-primary-teal">
              ...
              <div className="flex items-center justify-center space-x-4">
                <a
                  ...
                  className="w-10 h-10 bg-primary-turquoise/10 hover:bg-primary-turquoise dark:hover:bg-primary-light rounded-lg flex items-center justify-center transition-colors duration-300 group"
                  aria-label="LinkedIn"
                >
                  <svg
